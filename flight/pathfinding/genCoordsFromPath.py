...
from flight.pathfinding.genNodesFromMines import Node, Mine, Field, Connection
...
def generateGotoPoints(nodeList:Node, step: int = 10, arc_step: float= 0.349): #arc step in radians for 2 deg --> Todo: create logic for arc_step and step #density (nodes per dist )/dist = number of goto points 
    finalGotoList = []   
