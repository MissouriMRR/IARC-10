...
def generateGotoPoints(nodeList:Node, step: int = 10): #distance between points is 10 feet, subject to change. NOTE: has to be int.
    finalGotoList = []   
    ...
    for i in range(len(nodeList) - 1):
        ...
        if n1.parentMine!=n2.parentMine or n1.floating or n2.floating:
            segmentList.append((isArc, [float(n1.x), float(n1.y)], [float(n2.x), float(n2.y)]))
            dx = n2.x - n1.x
            dy = n2.y - n1.y
