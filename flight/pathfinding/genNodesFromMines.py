...
class Field:
    ...
    def plotField(self,labeled:bool=False):
        ...
        print("Start plotting, nodes should already be finalized")
        for node in Node.nodeGraph.keys():
            if labeled:
    ...
    @staticmethod
    # Reports the safe path and mine coordinates.
    def reportCoordinates(safePath:dict) -> dict:
        data = {
            "path":safePath,
            "mineCoordinates": []
        }
        ...
        for mine in Mine.mines:
            data["mineCoordinates"].append((mine.x,mine.y))
        return data
"""MATH STUFF"""
...
###### Debugging moved to testCases.py ####
"""
TODO:
X=Done
- = Todo
