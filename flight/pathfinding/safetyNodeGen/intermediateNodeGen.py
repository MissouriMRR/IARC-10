...
for mine in field.mines:
    nodeList.extend(mine.getNodes()) # gives all the nodes generated by adding the mines. Only plots 
  
#step for linear, arc_step for arc to determine number of gotopts.
#MOST CURRENT--> ouputs all the nodes on mines
def generateGotoPoints(nodeList, step = 10, arc_step=0.05): #arc step in radians
    ...
    for i in range(len(nodeList) - 1):
        ...
        if n1.parentMine!=n2.parentMine or n1.floating or n2.floating:
            ...
            numPoints = max(5, int(abs(delta_theta) / arc_step)) # 20 is the min num of points --> subject to change.
